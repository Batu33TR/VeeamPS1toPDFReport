...
.EXAMPLE
    .\VeeamReport7Days.ps1.ps1 -CustomerName "CompanyName Ltd." -OutputFolder "D:\Reports" -ReportDays 30

.EXAMPLE
    # HTML only, skip PDF
    .\VeeamReport7Days.ps1.ps1 -CustomerName "CompanyName Ltd." -SkipPdf
#>
